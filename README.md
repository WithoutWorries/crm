...
- `PATCH/DELETE /api/tax/entries/[id]` - Correct a remittance, record its payment, or remove it and recalculate VAT
- `GET /api/tax/remittances` - Private complete remittance archive with associated work sessions
